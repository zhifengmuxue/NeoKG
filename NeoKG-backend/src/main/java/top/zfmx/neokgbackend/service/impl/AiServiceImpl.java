    ...
    public Flux<ServerSentEvent<String>> askQuestion(String question, String sessionId) {
        ...
        messages.add(new UserMessage(
                "问题：" + question +
                        ...
                        "\n 请注意" +
                        "1.请基于以上内容，简洁、专业、准确地回答用户的问题。" +
                        "2.阐明你是从图谱中获取到了怎样的知识证明了你的回答或者是从文档内容中找到了相关的内容进行回答" +
                        "3.如果用户的问题与知识图谱和文档内容无关，请引导用户提问与知识图谱相关的问题。" +
                        "4.用户可能提出的问题是图谱中的关键词节点，并不带有描述，请你自行搜索相关的内容进行回答" +
                        "5.如果用户想你打招呼，请你友好地回应，不需要提及图谱内容"
        ));
